...
const filePath =
  "C:/Users/mblijswijk/VS projects/underground-voxel-viewer-for-laymen/data/FRE16/netcdf/2025-02-08-FRE16-sensitive_clay_probability-subset.nc";
...
const indicesToKeep = resistivity.map((item, index) => item >= 0 ? index : -1).filter(index => index !== -1);
