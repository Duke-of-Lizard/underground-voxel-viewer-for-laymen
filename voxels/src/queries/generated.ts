...
export type ResolversTypes = {
  ...
  AdminInviteList: ResolverTypeWrapper<
    Omit<AdminInviteList, 'items'> & { items: Array<ResolversTypes['ServerInvite']> }
  >
  AdminMutations: ResolverTypeWrapper<AdminMutations>
  AdminQueries: ResolverTypeWrapper<
    Omit<AdminQueries, 'inviteList' | 'projectList' | 'workspaceList'> & {
      inviteList: ResolversTypes['AdminInviteList']
  ...
  AdminUsersListItem: ResolverTypeWrapper<
    Omit<AdminUsersListItem, 'invitedUser' | 'registeredUser'> & {
      invitedUser?: Maybe<ResolversTypes['ServerInvite']>
      registeredUser?: Maybe<ResolversTypes['User']>
    }
  >
  ...
  AutomateFunction: ResolverTypeWrapper<
    Omit<AutomateFunction, 'creator'> & { creator?: Maybe<ResolversTypes['LimitedUser']> }
  >
  AutomateFunctionCollection: ResolverTypeWrapper<
    Omit<AutomateFunctionCollection, 'items'> & { items: Array<ResolversTypes['AutomateFunction']> }
  >
  AutomateFunctionRelease: ResolverTypeWrapper<
    Omit<AutomateFunctionRelease, 'function'> & { function: ResolversTypes['AutomateFunction'] }
  >
  ...
  AutomateFunctionRun: ResolverTypeWrapper<
    Omit<AutomateFunctionRun, 'function'> & { function?: Maybe<ResolversTypes['AutomateFunction']> }
  >
  ...
  AutomateMutations: ResolverTypeWrapper<
    Omit<AutomateMutations, 'createFunction' | 'updateFunction'> & {
      createFunction: ResolversTypes['AutomateFunction']
      updateFunction: ResolversTypes['AutomateFunction']
    }
  >
  ...
  Comment: ResolverTypeWrapper<Omit<Comment, 'author'> & { author: ResolversTypes['LimitedUser'] }>
  ...
  CommentReplyAuthorCollection: ResolverTypeWrapper<
    Omit<CommentReplyAuthorCollection, 'items'> & { items: Array<ResolversTypes['LimitedUser']> }
  >
  ...
  GendoAIRender: ResolverTypeWrapper<Omit<GendoAiRender, 'user'> & { user?: Maybe<ResolversTypes['LimitedUser']> }>
  ...
  LimitedUser: ResolverTypeWrapper<
    Omit<LimitedUser, 'commits' | 'streams'> & {
      commits?: Maybe<ResolversTypes['CommitCollection']>
      streams: ResolversTypes['UserStreamCollection']
    }
  >
  ...
  Model: ResolverTypeWrapper<
    Omit<
      Model,
      'author' | 'automationsStatus' | 'childrenTree' | 'pendingImportedVersions' | 'version' | 'versions'
    > & {
      author?: Maybe<ResolversTypes['LimitedUser']>
  ...
  PendingStreamCollaborator: ResolverTypeWrapper<
    Omit<PendingStreamCollaborator, 'invitedBy' | 'user'> & {
      invitedBy: ResolversTypes['LimitedUser']
      user?: Maybe<ResolversTypes['LimitedUser']>
    }
  >
  PendingWorkspaceCollaborator: ResolverTypeWrapper<
    Omit<PendingWorkspaceCollaborator, 'invitedBy' | 'user'> & {
      invitedBy: ResolversTypes['LimitedUser']
      user?: Maybe<ResolversTypes['LimitedUser']>
    }
  >
  ...
  ProjectAccessRequest: ResolverTypeWrapper<
    Omit<ProjectAccessRequest, 'project' | 'requester'> & {
      project: ResolversTypes['Project']
      requester: ResolversTypes['LimitedUser']
    }
  >
  ...
  ServerMultiRegionConfiguration: ResolverTypeWrapper<ServerMultiRegionConfiguration>
  ...
  >
  StreamAccessRequest: ResolverTypeWrapper<
    Omit<StreamAccessRequest, 'requester' | 'stream'> & {
      requester: ResolversTypes['LimitedUser']
      stream: ResolversTypes['Stream']
    }
  >
  ...
  User: ResolverTypeWrapper<
    ...
    > & {
      ...
      automateFunctions: ResolversTypes['AutomateFunctionCollection']
      commits?: Maybe<ResolversTypes['CommitCollection']>
      favoriteStreams: ResolversTypes['StreamCollection']
      projectAccessRequest?: Maybe<ResolversTypes['ProjectAccessRequest']>
      projects: ResolversTypes['UserProjectCollection']
      streams: ResolversTypes['UserStreamCollection']
      workspaceInvites: Array<ResolversTypes['PendingWorkspaceCollaborator']>
  ...
  UserProjectCollection: ResolverTypeWrapper<
    Omit<UserProjectCollection, 'items'> & { items: Array<ResolversTypes['Project']> }
  >
  ...
  UserRoleInput: UserRoleInput
  UserSearchResultCollection: ResolverTypeWrapper<
    Omit<UserSearchResultCollection, 'items'> & { items: Array<ResolversTypes['LimitedUser']> }
  >
  UserStreamCollection: ResolverTypeWrapper<
    Omit<UserStreamCollection, 'items'> & { items?: Maybe<Array<ResolversTypes['Stream']>> }
  >
  ...
  Version: ResolverTypeWrapper<
    Omit<Version, 'authorUser' | 'automationsStatus' | 'model'> & {
      authorUser?: Maybe<ResolversTypes['LimitedUser']>
      automationsStatus?: Maybe<ResolversTypes['TriggeredAutomationsStatus']>
      model: ResolversTypes['Model']
    }
  >
  ...
  ViewerUserActivityMessage: ResolverTypeWrapper<
    Omit<ViewerUserActivityMessage, 'user'> & { user?: Maybe<ResolversTypes['LimitedUser']> }
  >
  ...
  Workspace: ResolverTypeWrapper<
    Omit<Workspace, 'adminWorkspacesJoinRequests' | 'automateFunctions' | 'invitedTeam' | 'projects' | 'team'> & {
      adminWorkspacesJoinRequests?: Maybe<ResolversTypes['WorkspaceJoinRequestCollection']>
      automateFunctions: ResolversTypes['AutomateFunctionCollection']
      invitedTeam?: Maybe<Array<ResolversTypes['PendingWorkspaceCollaborator']>>
      projects: ResolversTypes['ProjectCollection']
      team: ResolversTypes['WorkspaceCollaboratorCollection']
    }
  >
  WorkspaceBillingMutations: ResolverTypeWrapper<WorkspaceBillingMutations>
  WorkspaceCollaborator: ResolverTypeWrapper<
    Omit<WorkspaceCollaborator, 'projectRoles' | 'user'> & {
      projectRoles: Array<ResolversTypes['ProjectRole']>
      user: ResolversTypes['LimitedUser']
    }
  >
  ...
  WorkspaceJoinRequest: ResolverTypeWrapper<
    Omit<WorkspaceJoinRequest, 'user' | 'workspace'> & {
      user: ResolversTypes['LimitedUser']
      workspace: ResolversTypes['Workspace']
    }
  >
  WorkspaceJoinRequestCollection: ResolverTypeWrapper<
    Omit<WorkspaceJoinRequestCollection, 'items'> & { items: Array<ResolversTypes['WorkspaceJoinRequest']> }
  >
  WorkspaceJoinRequestMutations: ResolverTypeWrapper<WorkspaceJoinRequestMutations>
  ...
  WorkspaceMutations: ResolverTypeWrapper<
    ...
    > & {
      ...
      setDefaultRegion: ResolversTypes['Workspace']
  ...
  WorkspaceProjectMutations: ResolverTypeWrapper<
    Omit<WorkspaceProjectMutations, 'create' | 'moveToWorkspace' | 'updateRole'> & {
      create: ResolversTypes['Project']
  ...
  WorkspaceProjectsUpdatedMessage: ResolverTypeWrapper<
    Omit<WorkspaceProjectsUpdatedMessage, 'project'> & { project?: Maybe<ResolversTypes['Project']> }
  >
  ...
  WorkspaceSso: ResolverTypeWrapper<WorkspaceSso>
  ...
  WorkspaceUpdatedMessage: ResolverTypeWrapper<
    Omit<WorkspaceUpdatedMessage, 'workspace'> & { workspace: ResolversTypes['Workspace'] }
  >
}
...
export type ResolversParentTypes = {
  ...
  AdminQueries: Omit<AdminQueries, 'inviteList' | 'projectList' | 'workspaceList'> & {
    inviteList: ResolversParentTypes['AdminInviteList']
  ...
  AdminUsersListItem: Omit<AdminUsersListItem, 'invitedUser' | 'registeredUser'> & {
    invitedUser?: Maybe<ResolversParentTypes['ServerInvite']>
  ...
  AutomateAuthCodePayloadTest: AutomateAuthCodePayloadTest
  AutomateFunction: Omit<AutomateFunction, 'creator'> & { creator?: Maybe<ResolversParentTypes['LimitedUser']> }
  AutomateFunctionCollection: Omit<AutomateFunctionCollection, 'items'> & {
    items: Array<ResolversParentTypes['AutomateFunction']>
  }
  AutomateFunctionRelease: Omit<AutomateFunctionRelease, 'function'> & {
    function: ResolversParentTypes['AutomateFunction']
  }
  AutomateFunctionReleaseCollection: AutomateFunctionReleaseCollection
  AutomateFunctionReleasesFilter: AutomateFunctionReleasesFilter
  AutomateFunctionRun: Omit<AutomateFunctionRun, 'function'> & {
    function?: Maybe<ResolversParentTypes['AutomateFunction']>
  }
  ...
  AutomateFunctionsFilter: AutomateFunctionsFilter
  AutomateMutations: Omit<AutomateMutations, 'createFunction' | 'updateFunction'> & {
    createFunction: ResolversParentTypes['AutomateFunction']
    updateFunction: ResolversParentTypes['AutomateFunction']
  }
  ...
  CheckoutSessionInput: CheckoutSessionInput
  Comment: Omit<Comment, 'author'> & { author: ResolversParentTypes['LimitedUser'] }
  ...
  CommentEditInput: CommentEditInput
  CommentMutations: CommentMutations
  CommentReplyAuthorCollection: Omit<CommentReplyAuthorCollection, 'items'> & {
    items: Array<ResolversParentTypes['LimitedUser']>
  }
  ...
  GendoAIRender: Omit<GendoAiRender, 'user'> & { user?: Maybe<ResolversParentTypes['LimitedUser']> }
  GendoAIRenderCollection: GendoAiRenderCollection
  GendoAIRenderInput: GendoAiRenderInput
  JSONObject: Scalars['JSONObject']['output']
  JoinWorkspaceInput: JoinWorkspaceInput
  LegacyCommentViewerData: LegacyCommentViewerData
  LimitedUser: Omit<LimitedUser, 'commits' | 'streams'> & {
    commits?: Maybe<ResolversParentTypes['CommitCollection']>
    streams: ResolversParentTypes['UserStreamCollection']
  }
  ...
  Model: Omit<
    ...
    'author' | 'automationsStatus' | 'childrenTree' | 'pendingImportedVersions' | 'version' | 'versions'
  > & {
    author?: Maybe<ResolversParentTypes['LimitedUser']>
  ...
  PendingStreamCollaborator: Omit<PendingStreamCollaborator, 'invitedBy' | 'user'> & {
    invitedBy: ResolversParentTypes['LimitedUser']
    user?: Maybe<ResolversParentTypes['LimitedUser']>
  }
  PendingWorkspaceCollaborator: Omit<PendingWorkspaceCollaborator, 'invitedBy' | 'user'> & {
    invitedBy: ResolversParentTypes['LimitedUser']
    user?: Maybe<ResolversParentTypes['LimitedUser']>
  }
  PendingWorkspaceCollaboratorsFilter: PendingWorkspaceCollaboratorsFilter
  ...
  > & {
    ...
    team: Array<ResolversParentTypes['ProjectCollaborator']>
    version: ResolversParentTypes['Version']
    versions: ResolversParentTypes['VersionCollection']
    workspace?: Maybe<ResolversParentTypes['Workspace']>
  }
  ProjectAccessRequest: Omit<ProjectAccessRequest, 'project' | 'requester'> & {
    project: ResolversParentTypes['Project']
    requester: ResolversParentTypes['LimitedUser']
  }
  ...
  ServerMultiRegionConfiguration: ServerMultiRegionConfiguration
  ...
  StreamAccessRequest: Omit<StreamAccessRequest, 'requester' | 'stream'> & {
    requester: ResolversParentTypes['LimitedUser']
    stream: ResolversParentTypes['Stream']
  }
  ...
  > & {
    ...
    automateFunctions: ResolversParentTypes['AutomateFunctionCollection']
    commits?: Maybe<ResolversParentTypes['CommitCollection']>
    favoriteStreams: ResolversParentTypes['StreamCollection']
    projectAccessRequest?: Maybe<ResolversParentTypes['ProjectAccessRequest']>
    projects: ResolversParentTypes['UserProjectCollection']
    streams: ResolversParentTypes['UserStreamCollection']
    workspaceInvites: Array<ResolversParentTypes['PendingWorkspaceCollaborator']>
  ...
  UserRoleInput: UserRoleInput
  UserSearchResultCollection: Omit<UserSearchResultCollection, 'items'> & {
    items: Array<ResolversParentTypes['LimitedUser']>
  }
  ...
  UsersRetrievalInput: UsersRetrievalInput
  VerifyUserEmailInput: VerifyUserEmailInput
  Version: Omit<Version, 'authorUser' | 'automationsStatus' | 'model'> & {
    authorUser?: Maybe<ResolversParentTypes['LimitedUser']>
    automationsStatus?: Maybe<ResolversParentTypes['TriggeredAutomationsStatus']>
    model: ResolversParentTypes['Model']
  }
  ...
  ViewerUpdateTrackingTarget: ViewerUpdateTrackingTarget
  ViewerUserActivityMessage: Omit<ViewerUserActivityMessage, 'user'> & {
    user?: Maybe<ResolversParentTypes['LimitedUser']>
  }
  ViewerUserActivityMessageInput: ViewerUserActivityMessageInput
  Webhook: Webhook
  ...
  Workspace: Omit<
    Workspace,
    'adminWorkspacesJoinRequests' | 'automateFunctions' | 'invitedTeam' | 'projects' | 'team'
  > & {
    adminWorkspacesJoinRequests?: Maybe<ResolversParentTypes['WorkspaceJoinRequestCollection']>
    automateFunctions: ResolversParentTypes['AutomateFunctionCollection']
    invitedTeam?: Maybe<Array<ResolversParentTypes['PendingWorkspaceCollaborator']>>
  ...
  WorkspaceCollaborator: Omit<WorkspaceCollaborator, 'projectRoles' | 'user'> & {
    projectRoles: Array<ResolversParentTypes['ProjectRole']>
    user: ResolversParentTypes['LimitedUser']
  }
  ...
  WorkspaceInviteResendInput: WorkspaceInviteResendInput
  WorkspaceInviteUseInput: WorkspaceInviteUseInput
  WorkspaceJoinRequest: Omit<WorkspaceJoinRequest, 'user' | 'workspace'> & {
    user: ResolversParentTypes['LimitedUser']
    workspace: ResolversParentTypes['Workspace']
  }
  WorkspaceJoinRequestCollection: Omit<WorkspaceJoinRequestCollection, 'items'> & {
    items: Array<ResolversParentTypes['WorkspaceJoinRequest']>
  }
  WorkspaceJoinRequestMutations: WorkspaceJoinRequestMutations
  ...
  > & {
    ...
    setDefaultRegion: ResolversParentTypes['Workspace']
  ...
  WorkspaceProjectCreateInput: WorkspaceProjectCreateInput
  WorkspaceProjectInviteCreateInput: WorkspaceProjectInviteCreateInput
  WorkspaceProjectMutations: Omit<WorkspaceProjectMutations, 'create' | 'moveToWorkspace' | 'updateRole'> & {
    create: ResolversParentTypes['Project']
    moveToWorkspace: ResolversParentTypes['Project']
    updateRole: ResolversParentTypes['Project']
  }
  WorkspaceProjectsFilter: WorkspaceProjectsFilter
  WorkspaceProjectsUpdatedMessage: Omit<WorkspaceProjectsUpdatedMessage, 'project'> & {
    project?: Maybe<ResolversParentTypes['Project']>
  }
  WorkspaceRequestToJoinInput: WorkspaceRequestToJoinInput
  WorkspaceRoleDeleteInput: WorkspaceRoleDeleteInput
...
> = {
  updateWorkspacePlan?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<AdminMutationsUpdateWorkspacePlanArgs, 'input'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
export type AutomateFunctionTokenResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['AutomateFunctionToken'] = ResolversParentTypes['AutomateFunctionToken'],
> = {
  functionId?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
> = {
  ...
  >
  createFunctionWithoutVersion?: Resolver<
    ResolversTypes['AutomateFunctionToken'],
    ParentType,
    ContextType,
    RequireFields<AutomateMutationsCreateFunctionWithoutVersionArgs, 'input'>
  >
...
> = {
  archive?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<CommentMutationsArchiveArgs, 'input'>
  >
  create?: Resolver<
  ...
  markViewed?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<CommentMutationsMarkViewedArgs, 'input'>
  >
  reply?: Resolver<
    ResolversTypes['Comment'],
    ParentType,
...
> = {
  ...
  role?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
  streams?: Resolver<
    ResolversTypes['UserStreamCollection'],
    ParentType,
    ContextType,
  ...
  >
  workspaceRole?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType,
    Partial<LimitedUserWorkspaceRoleArgs>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type LimitedWorkspaceResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['LimitedWorkspace'] = ResolversParentTypes['LimitedWorkspace'],
> = {
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  logo?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
...
> = {
  ...
  streams?: Resolver<
    Maybe<ResolversTypes['UserStreamCollection']>,
    ParentType,
    ContextType,
  ...
  >
  usersByEmail?: Resolver<
    Array<Maybe<ResolversTypes['LimitedUser']>>,
    ParentType,
    ContextType,
    RequireFields<QueryUsersByEmailArgs, 'input'>
  >
  ...
  workspaceSsoByEmail?: Resolver<
    Array<ResolversTypes['LimitedWorkspace']>,
    ParentType,
    ContextType,
    RequireFields<QueryWorkspaceSsoByEmailArgs, 'email'>
  >
}
...
export type ServerInfoMutationsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['ServerInfoMutations'] = ResolversParentTypes['ServerInfoMutations'],
> = {
...
export type ServerMultiRegionConfigurationResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ServerMultiRegionConfiguration'] = ResolversParentTypes['ServerMultiRegionConfiguration'],
> = {
...
export type ServerRegionItemResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['ServerRegionItem'] = ResolversParentTypes['ServerRegionItem'],
> = {
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type ServerRegionMutationsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['ServerRegionMutations'] = ResolversParentTypes['ServerRegionMutations'],
> = {
  create?: Resolver<
    ResolversTypes['ServerRegionItem'],
    ParentType,
    ContextType,
    RequireFields<ServerRegionMutationsCreateArgs, 'input'>
  >
  update?: Resolver<
    ResolversTypes['ServerRegionItem'],
    ParentType,
    ContextType,
    RequireFields<ServerRegionMutationsUpdateArgs, 'input'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  >
  workspaceProjectsUpdated?: SubscriptionResolver<
    ResolversTypes['WorkspaceProjectsUpdatedMessage'],
    'workspaceProjectsUpdated',
    ParentType,
    ContextType,
    Partial<SubscriptionWorkspaceProjectsUpdatedArgs>
  >
  workspaceUpdated?: SubscriptionResolver<
    ResolversTypes['WorkspaceUpdatedMessage'],
    'workspaceUpdated',
    ParentType,
    ContextType,
    Partial<SubscriptionWorkspaceUpdatedArgs>
  >
}
...
> = {
  ...
  automateFunctions?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<UserAutomateFunctionsArgs>
  >
  ...
  projects?: Resolver<
    ResolversTypes['UserProjectCollection'],
    ParentType,
    ContextType,
...
> = {
  ...
  verify?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<UserEmailMutationsVerifyArgs, 'input'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
export type UserGendoAiCreditsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['UserGendoAICredits'] = ResolversParentTypes['UserGendoAICredits'],
> = {
...
export type UserProjectCollectionResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['UserProjectCollection'] = ResolversParentTypes['UserProjectCollection'],
> = {
  cursor?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
  items?: Resolver<Array<ResolversTypes['Project']>, ParentType, ContextType>
...
export type UserStreamCollectionResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['UserStreamCollection'] = ResolversParentTypes['UserStreamCollection'],
> = {
  cursor?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
  items?: Resolver<Maybe<Array<ResolversTypes['Stream']>>, ParentType, ContextType>
  numberOfHidden?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
...
> = {
  adminWorkspacesJoinRequests?: Resolver<
    Maybe<ResolversTypes['WorkspaceJoinRequestCollection']>,
    ParentType,
    ContextType,
    RequireFields<WorkspaceAdminWorkspacesJoinRequestsArgs, 'limit'>
  >
  automateFunctions?: Resolver<
    ResolversTypes['AutomateFunctionCollection'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceAutomateFunctionsArgs, 'limit'>
  >
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  ...
  hasAccessToFeature?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceHasAccessToFeatureArgs, 'featureName'>
  >
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type WorkspaceBillingMutationsResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['WorkspaceBillingMutations'] = ResolversParentTypes['WorkspaceBillingMutations'],
> = {
  cancelCheckoutSession?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceBillingMutationsCancelCheckoutSessionArgs, 'input'>
  >
  createCheckoutSession?: Resolver<
    ResolversTypes['CheckoutSession'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceBillingMutationsCreateCheckoutSessionArgs, 'input'>
  >
  upgradePlan?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceBillingMutationsUpgradePlanArgs, 'input'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
export type WorkspaceCreationStateResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['WorkspaceCreationState'] = ResolversParentTypes['WorkspaceCreationState'],
> = {
...
export type WorkspaceJoinRequestResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['WorkspaceJoinRequest'] = ResolversParentTypes['WorkspaceJoinRequest'],
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type WorkspaceJoinRequestCollectionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['WorkspaceJoinRequestCollection'] = ResolversParentTypes['WorkspaceJoinRequestCollection'],
> = {
  cursor?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
...
export type WorkspaceJoinRequestMutationsResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['WorkspaceJoinRequestMutations'] = ResolversParentTypes['WorkspaceJoinRequestMutations'],
> = {
  approve?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceJoinRequestMutationsApproveArgs, 'input'>
  >
  deny?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceJoinRequestMutationsDenyArgs, 'input'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  >
  deleteSsoProvider?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceMutationsDeleteSsoProviderArgs, 'workspaceId'>
  >
  dismiss?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceMutationsDismissArgs, 'input'>
  >
  ...
  requestToJoin?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceMutationsRequestToJoinArgs, 'input'>
  >
  setDefaultRegion?: Resolver<
    ResolversTypes['Workspace'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceMutationsSetDefaultRegionArgs, 'regionKey' | 'workspaceId'>
  >
  update?: Resolver<
    ResolversTypes['Workspace'],
    ParentType,
  ...
  >
  updateCreationState?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<WorkspaceMutationsUpdateCreationStateArgs, 'input'>
  >
  updateRole?: Resolver<
    ResolversTypes['Workspace'],
    ParentType,
...
export type WorkspacePlanResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['WorkspacePlan'] = ResolversParentTypes['WorkspacePlan'],
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
...
> = {
  create?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<WorkspaceProjectMutationsCreateArgs, 'input'>
  >
...
export type WorkspaceProjectsUpdatedMessageResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['WorkspaceProjectsUpdatedMessage'] = ResolversParentTypes['WorkspaceProjectsUpdatedMessage'],
> = {
  project?: Resolver<Maybe<ResolversTypes['Project']>, ParentType, ContextType>
  projectId?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type WorkspaceSsoResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['WorkspaceSso'] = ResolversParentTypes['WorkspaceSso'],
> = {
...
export type WorkspaceSsoProviderResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['WorkspaceSsoProvider'] = ResolversParentTypes['WorkspaceSsoProvider'],
> = {
...
export type WorkspaceSsoSessionResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['WorkspaceSsoSession'] = ResolversParentTypes['WorkspaceSsoSession'],
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
...
export type WorkspaceSubscriptionSeatsResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['WorkspaceSubscriptionSeats'] = ResolversParentTypes['WorkspaceSubscriptionSeats'],
> = {
...
export type WorkspaceUpdatedMessageResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['WorkspaceUpdatedMessage'] = ResolversParentTypes['WorkspaceUpdatedMessage'],
> = {
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  workspace?: Resolver<ResolversTypes['Workspace'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type CreateProjectMutation = {
  __typename?: 'Mutation'
  projectMutations: { __typename?: 'ProjectMutations'; create: { __typename?: 'Project'; id: string } }
}

export type CreateNewModelMutationVariables = Exact<{
  input: CreateModelInput
}>

export type CreateNewModelMutation = {
  __typename?: 'Mutation'
  modelMutations: { __typename?: 'ModelMutations'; create: { __typename?: 'Model'; id: string } }
}
...
export type CreateNewVersionMutation = {
  __typename?: 'Mutation'
  versionMutations: { __typename?: 'VersionMutations'; create: { __typename?: 'Version'; id: string } }
}
...
>
export const CreateNewModelDocument = gql`
  mutation createNewModel($input: CreateModelInput!) {
    modelMutations {
      create(input: $input) {
        id
      }
...
`
export type CreateNewModelMutationFn = Apollo.MutationFunction<CreateNewModelMutation, CreateNewModelMutationVariables>

/**
 * __useCreateNewModelMutation__
 *
 * To run a mutation, you first call `useCreateNewModelMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateNewModelMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createNewModelMutation, { data, loading, error }] = useCreateNewModelMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
...
export function useCreateNewModelMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateNewModelMutation, CreateNewModelMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<CreateNewModelMutation, CreateNewModelMutationVariables>(CreateNewModelDocument, options)
}
export type CreateNewModelMutationHookResult = ReturnType<typeof useCreateNewModelMutation>
export type CreateNewModelMutationResult = Apollo.MutationResult<CreateNewModelMutation>
export type CreateNewModelMutationOptions = Apollo.BaseMutationOptions<
  CreateNewModelMutation,
  CreateNewModelMutationVariables
>
export const CreateNewVersionDocument = gql`
  mutation createNewVersion($input: CreateVersionInput!) {
    versionMutations {
      create(input: $input) {
        id
      }
...
`
export type CreateNewVersionMutationFn = Apollo.MutationFunction<
  CreateNewVersionMutation,
  CreateNewVersionMutationVariables
>

/**
 * __useCreateNewVersionMutation__
 *
 * To run a mutation, you first call `useCreateNewVersionMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateNewVersionMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createNewVersionMutation, { data, loading, error }] = useCreateNewVersionMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
...
export function useCreateNewVersionMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateNewVersionMutation, CreateNewVersionMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<CreateNewVersionMutation, CreateNewVersionMutationVariables>(
    CreateNewVersionDocument,
    options,
  )
}
export type CreateNewVersionMutationHookResult = ReturnType<typeof useCreateNewVersionMutation>
export type CreateNewVersionMutationResult = Apollo.MutationResult<CreateNewVersionMutation>
export type CreateNewVersionMutationOptions = Apollo.BaseMutationOptions<
  CreateNewVersionMutation,
  CreateNewVersionMutationVariables
>
